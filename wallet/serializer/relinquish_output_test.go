...
func TestRelinquishOutputArgs(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			args: &wallet.RelinquishOutputArgs{
				Basket: "test-basket",
				Output: *tu.WalletOutpointFromString(t, "8a552c995db3602e85bb9df911803897d1ea17ba5cdd198605d014be49db9f72.0"),
			},
		},
		{
			name: "empty basket",
			args: &wallet.RelinquishOutputArgs{
				Basket: "",
				Output: *tu.WalletOutpointFromString(t, "8a552c995db3602e85bb9df911803897d1ea17ba5cdd198605d014be49db9f72.1"),
			},
		},
	}
